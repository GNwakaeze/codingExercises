...
def add_information_about_language(languages, language_name, info_key, info_value)
  # Take languages and add the key/value pair info_key/info_value to the nested hash of language_name,
...
def add_language(languages, language_name, language_info_value)
  # Take languages and add the key/value pair language_name/language_info_value to it,
  #then return languages
...
def delete_language(languages, language_name)
  # Take languages and delete the language_name key/value pair, then return languages
...
def find_beautiful_languages(languages)
  ...
  languages.select { |hash, inner_hash| inner_hash[:is_beautiful?] == true }
end

def find_language_facts(languages, language_name, fact_index = 0)
  # Take languages (now with additional facts added to each language with the key :facts and value of an array of strings) 
  # and return the fact language_name has at fact_index of its facts array, 
  # or at index 0 if this argument is not given
  languages.dig(language_name, :facts, fact_index) #this feels like a cheat because I didnt use the provided parameters, but I couldnt get it to work!! Any suggestions are welcome!
